...
func (r *CreateContractLog) Output(ctx context.Context) (interface{}, error) {
	...
	return monitor.Create(ctx, p, &models.MonitorInfo{
		Type:        enums.MONITOR_TYPE__CONTRACT_LOG,
		ContractLog: &r.CreateContractLogReq,
	})
}
...
func (r *CreateChainTx) Output(ctx context.Context) (interface{}, error) {
	...
	return monitor.Create(ctx, p, &models.MonitorInfo{
		Type:    enums.MONITOR_TYPE__CHAIN_TX,
		ChainTx: &r.CreateChainTxReq,
	})
}
...
func (r *CreateChainHeight) Output(ctx context.Context) (interface{}, error) {
	...
	return monitor.Create(ctx, p, &models.MonitorInfo{
		Type:        enums.MONITOR_TYPE__CHAIN_HEIGHT,
		ChainHeight: &r.CreateChainHeightReq,
	})
}
