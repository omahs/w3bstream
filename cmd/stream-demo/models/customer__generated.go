...
func init() {
	CustomerTable = InsDB.Register(&Customer{})
}
...
func (m *Customer) ColAddress() *builder.Column {
	return CustomerTable.ColByFieldName(m.FieldAddress())
}

func (*Customer) FieldAddress() string {
	return "Address"
}
